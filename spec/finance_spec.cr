...
describe "Payment" do
  it "Calculates PMT" do
    pmt_0 = Financials.pmt(9.3, 36, -12995.0, 6000.0, 0)
    pmt_0.should eq(269.9170849608034)

    pmt_1 = Financials.pmt(9.3, 36, -12995.0, 6000.0, 1)
...
describe "Present Value" do
  it "Calculates PV" do
    pv_0 = Financials.pv(120.00, 1, 100.00, 100.00, 0)
    pv_0.should eq(-181.8181818181819)

    pv_1 = Financials.pv(120.00, 1, 100.00, 100.00, 1)
...
describe "NPER" do
  it "Calculates NPER" do
    nper_0 = Financials.nper(10, 2625.73, -81374.62, 0, 0)
...
describe "FV" do
  it "Calculates FV" do
    fv_0 = Financials.fv(5.8, 48, 2265.63, -133781.21, 0)
    fv_0.should eq(46550.000266654475)

    fv_1 = Financials.fv(5.8, 48, 2265.63, -133781.21, 1)
    fv_1.should eq(45959.99594010557)

    fv_2 = Financials.fv(10, 36, 2625.73, -81374.62, 0)
